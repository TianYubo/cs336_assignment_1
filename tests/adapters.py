...
from cs336_basics.char_based_bpe import bpe_trainer_main

# from cs336_basics.char_based_bpe_class import BPETrainer
from cs336_basics.byte_based_bpe_final import ByteBPETrainer
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    # vocab, merged_rules = bpe_trainer_main(input_path, vocab_size, special_tokens, **kwargs)

    trainer = ByteBPETrainer(vocab_size=vocab_size, special_tokens=special_tokens)

    # 训练模型
    vocab_dict, merged_rules = trainer.train(input_path)
    return vocab_dict, merged_rules
